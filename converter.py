...
filename = 'c:\\Users\\AOZ\\Desktop\\Chess-Game\\meme.jpg'
...
encoded_b2 = "".join([format(n, '08b') for n in StrC])
# print(encoded_b2)

decoded_b2 = [int(encoded_b2[i:i + 8], 2)
              for i in range(0, len(encoded_b2), 8)]
