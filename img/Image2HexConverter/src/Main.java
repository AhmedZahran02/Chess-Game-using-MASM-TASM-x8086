...
//        CreateResFile("InputFile/" , "res" , img );
        FileOutputStream out = new FileOutputStream("OutputFile/select2.bin");
        WriteBinaryHexImage(out , new File("InputFile/select2.png") , img);
    }
    ...
    private static void WriteBinaryHexImage(OutputStream o, File image , BufferedImage palette) throws IOException {
        BufferedImage img = ImageIO.read(image);
    ...
    public static double DistanceRGB(int c0 , int c1){
        int a0 = (c0 >> 24) & 0xff;
        int r0 = (c0 >> 16) & 0xff ;
        int b0 = (c0 >> 8)  & 0xff ;
        int g0 = c0       & 0xff ;
